...
model_opened <- lm(opened ~ variant_assignment, data = data_subset)
...
model_click <- lm(click ~ variant_assignment, data = data_subset2)
...
print(data_subset2)
model_click <- lm(visit ~ variant_assignment, data = data_subset2)
...
model <- lm(visit ~ variant_assignment * not_seen_recently, data = d_filtered)
